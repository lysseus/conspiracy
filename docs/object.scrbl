...
@subsection{@tt{characteristics-template?}}

Returns true if the object is a characteristics-template; otherwise it returns false.

@bold{Syntax:}
@verbatim|{
(|@bold{@"@"} |@bold{characteristics-template?} |@italic{objname})
 |@italic{objname} : |@tt{object?}
}|
...
@bold{Syntax:}
@verbatim|{
(|@bold{@"@"} |@bold{create-clone})
}|

@subsection{@tt{create-clone/ε}}

Like @tt{create-clone}, exceept that the object's @tt{construct} is executed, any ε-props methods from the original object are removed prior to consturction. An @italic{objname} can be provided, but must not already be registered in the database. 

@bold{Syntax:}
@verbatim|{
(|@bold{@"@"} |@bold{create-clone/ε} [|@italic{objname}])
  |@italic{objname} : |@tt{(and/c symbol? (not/c object?))}
  }|
...
@bold{Syntax:}
@verbatim|{
(|@bold{@"@"} |@bold{flags!} |@italic{objname}  |@italic{flag} [|@italic{flag} ...])
 |@italic{objname} : |@tt{object?}
 |@italic{flag}    : symbol?
}|
